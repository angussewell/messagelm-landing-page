  ...
  return (
    <section
      className={cn(
        ...
        "pt-24 pb-8 sm:pt-32 md:pt-40 lg:pt-48 sm:pb-12 md:pb-16 px-4 sm:px-6",
        "overflow-hidden"
      )}
    >
      {/* Background Effects */}
      ...
      <div className="mx-auto flex max-w-container flex-col gap-6 sm:gap-8 md:gap-10">
        <div className="flex flex-col items-center gap-4 sm:gap-6 text-center">
          ...
          {/* Title */}
          <motion.h1 
            className="relative z-10 inline-block animate-appear bg-gradient-to-br from-brand via-brand-purple to-brand-blue bg-clip-text text-3xl sm:text-4xl md:text-6xl lg:text-7xl font-semibold leading-tight text-transparent drop-shadow-sm sm:leading-tight md:leading-tight"
          ...
          {/* Description */}
          <motion.p 
            className="text-sm sm:text-md md:text-xl relative z-10 max-w-[600px] font-medium text-muted-foreground"
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
          ...
          {/* Actions */}
          <motion.div 
            className="relative z-10 flex flex-col sm:flex-row justify-center gap-3 sm:gap-4 w-full sm:w-auto"
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
