  ...
  return (
    ...
    >
      ...
      <div className="mx-auto flex max-w-container flex-col gap-4 sm:gap-8 md:gap-10">
        <div className="flex flex-col items-center gap-3 sm:gap-6 text-center px-2 sm:px-0">
          {/* Badge */}
          {badge && (
          ...
          {/* Title */}
          <motion.h1 
            className="relative z-10 inline-block animate-appear bg-gradient-to-br from-brand via-brand-purple to-brand-blue bg-clip-text text-3xl sm:text-4xl md:text-6xl lg:text-7xl font-semibold leading-tight text-transparent drop-shadow-sm sm:leading-tight md:leading-tight px-3 sm:px-2"
          ...
          {/* Description */}
          <motion.p 
            className="text-sm sm:text-md md:text-xl relative z-10 max-w-[600px] font-medium text-muted-foreground px-3 sm:px-2"
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
          ...
          {/* Actions */}
          <motion.div 
            className="relative z-10 flex flex-col sm:flex-row justify-center gap-2.5 sm:gap-4 w-full sm:w-auto px-4 sm:px-0"
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
        ...
        {/* Dashboard Mockup */}
        <motion.div
          className="relative z-10 w-full mx-auto px-1.5 sm:px-0"
